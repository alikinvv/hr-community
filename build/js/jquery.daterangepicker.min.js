    ...
    return U(this).off(".datepicker").on("click.datepicker", function (e) {
          ...
          if (s) {
            ...
            if (s["prev-days"] && 0 < s["prev-days"].length) {
              ...
              for (var i = 0; i < s["prev-days"].length; i++) {
                o = s["prev-days"][i], o += 1 < s["prev-days"][i] ? K("days") : K("day"), t += ' <a href="javascript:;" shortcut="day,-' + s["prev-days"][i] + '">' + o + "</a>";
              }
            ...
            if (s["next-days"] && 0 < s["next-days"].length) {
              ...
              for (var i = 0; i < s["next-days"].length; i++) {
                o = s["next-days"][i], o += 1 < s["next-days"][i] ? K("days") : K("day"), t += ' <a href="javascript:;" shortcut="day,' + s["next-days"][i] + '">' + o + "</a>";
              }
            ...
            if (s.prev && 0 < s.prev.length) {
              ...
              for (var i = 0; i < s.prev.length; i++) {
                o = K("prev-" + s.prev[i]), t += ' <a href="javascript:;" shortcut="prev,' + s.prev[i] + '">' + o + "</a>";
              }
            ...
            if (s.next && 0 < s.next.length) {
              ...
              for (var i = 0; i < s.next.length; i++) {
                o = K("next-" + s.next[i]), t += ' <a href="javascript:;" shortcut="next,' + s.next[i] + '">' + o + "</a>";
              }
      ...
      setTimeout(function () {
        ...
        if (-1 != t.indexOf("day")) {
          ...
          for (e = -1 != t.indexOf("prev,") ? -1 : 1, s = 1 == e ? "monday" == f.startOfWeek ? 1 : 0 : "monday" == f.startOfWeek ? 0 : 6, a = new Date(a.getTime() - 864e5); a.getDay() != s;) {
      ...
      setDateRange: function setDateRange(e, t, a) {
    ...
    function O(e, t) {
      ...
      m.find("." + t + " .month-name").html(a + " " + n), m.find("." + t + " tbody").html(function (e) {
        ...
        for (var d = e.getMonth(), o = 0; o < 40; o++) {
          a = Q(e).add(o, "days").toDate(), n = g(a.getTime()), f.startDate && H(a, f.startDate) < 0 && (n = !1), f.endDate && 0 < H(a, f.endDate) && (n = !1), t.push({
            date: a,
